...
const Summarize = ({ summarizeText, downloadTextFile }) => {
  const [isEditing, setIsEditing] = useState(false);
  const [editableText, setEditableText] = useState(summarizeText);
  ...
  return (
    <div>
      <div className="mt-6 w-full max-w-3xl bg-zinc-900 p-4 rounded-lg border border-zinc-700 shadow-lg relative">
        ...
        <Button
          className="hover:!bg-blue-800 !border-white !absolute !top-1  !right-9 !text-white"
          variant="outline"
        ...
        <div className="absolute top-3 right-3 flex items-center space-x-1 text-white">
          <svg
            ...
            onClick={() => downloadTextFile("summary.txt", editableText)}
            cursor="pointer"
            width="15"
            height="15"
            viewBox="0 0 15 15"
